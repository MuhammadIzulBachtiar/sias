								...
								<tbody id="isi">
									...
									<td>
										...
										<button class="btn btn-success btn-sm " style="margin:5px" data-toggle="modal" data-target="#update<?php echo $key->id_smasuk ?>">Edit</button>
											<a href="<?php echo base_url('operator/detailsuratmasuk/'.$key->id_smasuk) ?>" class="btn btn-primary btn-sm " style="margin:5px">Detail</a>
											<a href="<?php echo base_url('operator/delmasuk/'.$key->id_smasuk) ?>" class="btn btn-danger btn-sm " style="margin:5px" onclick="return confirm('Hapus surat masuk?')">Hapus</a>		
										</td>
									</tr>
								<?php endforeach ?>
								</tbody>
