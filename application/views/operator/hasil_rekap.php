					...
					<table class="table">
						...
						<tr>
							...
							<td>
								...
								<a href="<?php echo site_url('operator/cetak_exportsm/');?><?php echo $this->input->post('dari');?>/<?php echo $this->input->post('sampai');?>" target="_blank" class="btn btn-success"><i class="fa fa-download"></i> Export Excel</a>
							</td>
						</tr>
						<tr>
							<td>2</td>
							...
							<td>
								...
								<a href="<?php echo site_url('operator/cetak_exportsk/');?><?php echo $this->input->post('dari');?>/<?php echo $this->input->post('sampai');?>" target="_blank" class="btn btn-success"><i class="fa fa-download"></i> Export Excel</a>
							</td>
						</tr>
						<tr>
							<td>3</td>
							...
							<td>
								...
								<a href="<?php echo site_url('operator/cetak_export_undangan/');?><?php echo $this->input->post('dari');?>/<?php echo $this->input->post('sampai');?>" target="_blank" class="btn btn-success"><i class="fa fa-download"></i> Export Excel</a>
							</td>
						</tr>
						<tr>
							<td>4</td>
							...
							<td>
								...
								<a href="<?php echo site_url('operator/cetak_exportds/');?><?php echo $this->input->post('dari');?>/<?php echo $this->input->post('sampai');?>" target="_blank" class="btn btn-success"><i class="fa fa-download"></i> Export Excel</a>
							</td>
						</tr>
					</table>
				</div>
