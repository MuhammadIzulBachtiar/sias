							...
							<div class="table-responsive">
								<table class="display nowrap table  table-striped table-bordered">
									...
									<tr>
										...
										<th  style="width: 5%">:</th>
										<th><span style="font-weight: bold;"><?php echo $lama[0]->tgl_catat ?></span></th>
									</tr>
									<tr>
								...
								<!-- <button class="btn btn-primary" data-toggle="modal" data-target="#update">Edit</button> -->
								<a href="<?php echo base_url('operator/suratkeluar') ?>" class="btn btn-danger">Kembali</a>
								<br>
							</div>
						</div>
					</div>
