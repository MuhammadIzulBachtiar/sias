								...
								<tbody id="isi">
									...
									<tr>
										...
										<td>
											...
											<a href="<?php echo base_url('staff/detailsuratkeluar/'.$key->id_skeluar) ?>" class="btn btn-primary btn-sm " style="margin:5px">Detail</a>
											<a href="<?php echo base_url('staff/delkeluar/'.$key->id_skeluar) ?>" class="btn btn-danger btn-sm " style="margin:5px" onclick="return confirm('Hapus surat masuk?')">Hapus</a>
										</td>
									</tr>
								<?php endforeach ?>
							</tbody>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<input type="text" value="<?php echo $e->ditujukan ?>" class="form-control"  autocomplete="off" name="ditujukan">
								</div>
										<div class="form-group">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="row">
								...
								<div class="form-group">
									<label for="">Ditujukan</label>
									<input type="text" class="form-control" autocomplete="off" name="ditujukan">				
								</div>
